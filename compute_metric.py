...
def main():
    ...
    # Dataset parameters
    parser.add_argument('-g', '--gt_path', default='/media/jma/sg/junma/UniCell/AllCellImgs/CellUniverse/labelsTs', type=str, help='path to ground truth')
    parser.add_argument('-s', '--seg_path', type=str, help='path to segmentation results; file names are the same as ground truth', required=True)
    parser.add_argument('-thre', '--thresholds', nargs='+', default=[0.5, 0.6,0.7,0.8,0.9], type=float, help='threshold to count correct cells')
    parser.add_argument('-o', '--output_path', default='./', type=str, help='path where to save metrics')
    parser.add_argument('-n', '--save_name', default='seg_metric', type=str, help='name of the csv file')
    ...
    for threshold in args.thresholds:
        ...
        print('threshold:', threshold, 'mean F1 Score:', np.mean(metrics['F1']))
